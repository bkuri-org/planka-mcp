    ...
    switch (args.action) {
      case "get_projects":
        if (!args.page || !args.perPage)
          throw new Error("page and perPage are required for get_projects action");
      ...
      case "update_board":
        ...
        {
          const boardUpdateOptions: Record<string, unknown> = {
            name: args.name,
            position: args.position,
          };
          if (args.type) {
  ...
  async (args) => {
    ...
    switch (args.action) {
      ...
      case "update":
        ...
        {
          const cardUpdateOptions: Record<string, unknown> = {};
  ...
  async (args) => {
    ...
    switch (args.action) {
      ...
      case "update":
        if (!args.id) throw new Error("id is required for update action");
        {
          const taskUpdateOptions: Record<string, unknown> = {};
  ...
  async (args) => {
    ...
    switch (args.action) {
      ...
      case "update":
        if (!args.id) throw new Error("id is required for update action");
        {
          const membershipUpdateOptions: Record<string, unknown> = {};
